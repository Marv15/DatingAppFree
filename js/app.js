...
(function () {
  ...
  function renderMilestonesView() {
    ...
    const phasesWithMilestones = window.MilestoneManager.getPhasesWithMilestones(currentLang);
    ...
    phasesWithMilestones.forEach(phase => {
        ...
        item.innerHTML = `
          ...
          <div class="milestone-content">
            ...
            <div class="milestone-insight-box">
              <strong>${window.i18n.t('milestone_insight_label')}</strong> ${escapeHtml(m.insight)}
            </div>
          </div>
        `;
      ...
      els.milestonesList.appendChild(phaseCard);
    });
  }
